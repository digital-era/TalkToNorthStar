...
@media print {
    ...
    #print-overlay .thought-node h1, #print-overlay .thought-node h2, #print-overlay .thought-node h3 {
        font-family: -apple-system, BlinkMacSystemFont, "Microsoft YaHei", sans-serif !important;
        color: #111111 !important;
        margin-top: 15px !important; 
        margin-bottom: 8px !important; /* 标题下方留白稍微收紧 */

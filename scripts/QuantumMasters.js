const QuantumMasters = [
    { id: "max_planck", name: "Max Planck (马克斯·普朗克)",
      contribution: {
    ...
    { id: "albert_einstein", name: "Albert Einstein (阿尔伯特·爱因斯坦)",
      contribution: {
    ...
    { id: "niels_bohr", name: "Niels Bohr (尼尔斯·玻尔)",
      contribution: {
    ...
    { id: "werner_heisenberg", name: "Werner Heisenberg (维尔纳·海森堡)",
      contribution: {
    ...
    { id: "erwin_schrodinger", name: "Erwin Schrödinger (埃尔温·薛定谔)",
      contribution: {
    ...
    { id: "louis_de_broglie", name: "Louis de Broglie (路易·德布罗意)",
      contribution: {
    ...
    { id: "max_born", name: "Max Born (马克斯·玻恩)",
      contribution: {
    ...
    { id: "wolfgang_pauli", name: "Wolfgang Pauli (沃尔夫冈·泡利)",
      contribution: {
    ...
    { id: "paul_dirac", name: "Paul Dirac (保罗·狄拉克)",
      contribution: {
    ...
    { id: "john_von_neumann", name: "John von Neumann (约翰·冯·诺伊曼)",
      contribution: {
    ...
    { id: "bernhard_riemann", name: "Bernhard Riemann (伯恩哈德·黎曼)",
      contribution: {
    ...
    { id: "richard_feynman", name: "Richard Feynman (理查德·费曼)",
      contribution: {
    ...
    { id: "james_clerk_maxwell", name: "James Clerk Maxwell (詹姆斯·克拉克·麦克斯韦)",
      contribution: {
    ...
    { id: "hartmut_neven", name: "Hartmut Neven (哈特穆特·内文)",
      contribution: {
    ...
    { id: "john_preskill", name: "John Preskill (约翰·普雷斯基尔)",
      contribution: {
    ...
    { id: "jack_hidary", name: "Jack Hidary (杰克·希达里)",
      contribution: {
    ...
    { id: "chris_monroe", name: "Chris Monroe (克里斯·门罗)",
      contribution: {

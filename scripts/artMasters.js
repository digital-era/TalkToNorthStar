const artMasters = [
    { id: "leonardo_da_vinci", name: "Leonardo da Vinci (列奥纳多·达·芬奇)",
      contribution: {
    ...
    { id: "michelangelo", name: "Michelangelo (米开朗基罗)",
      contribution: {
    ...
    { id: "pablo_picasso", name: "Pablo Picasso (巴勃罗·毕加索)",
      contribution: {
    ...
    { id: "vincent_van_gogh", name: "Vincent van Gogh (文森特·凡·高)",
      contribution: {
    ...
    { id: "rembrandt_van_rijn", name: "Rembrandt van Rijn (伦勃朗·凡·莱因)",
      contribution: {
    ...
    { id: "claude_monet", name: "Claude Monet (克劳德·莫奈)",
      contribution: {
    ...
    { id: "andy_warhol", name: "Andy Warhol (安迪·沃霍尔)",
      contribution: {
    ...
    { id: "gustav_klimt", name: "Gustav Klimt (古斯塔夫·克林姆)",
      contribution: {
    ...
    { id: "frida_kahlo", name: "Frida Kahlo (弗里达·卡罗)",
      contribution: {
    ...
    { id: "ludwig_van_beethoven", name: "Ludwig van Beethoven (路德维希·凡·贝多芬)",
      contribution: {
    ...
    { id: "frederic_chopin", name: "Frédéric Chopin (弗雷德里克·肖邦)",
      contribution: {
    ...
    { id: "chip_kidd", name: "Chip Kidd (奇普·基德)",
      contribution: {
    ...
    { id: "jonathan_ive", name: "Jonathan Ive (乔纳森·艾夫)",
      contribution: {
    ...
    { id: "iris_van_herpen", name: "Iris van Herpen (伊里斯·范·赫彭)",
      contribution: {
    ...
    { id: "henri_cartier_bresson", name: "Henri Cartier-Bresson (亨利·卡蒂埃-布列松)",
      contribution: {
    ...
    { id: "annie_leibovitz", name: "Annie Leibovitz (安妮·莱博维茨)",
      contribution: {
    ...
    { id: "frank_lloyd_wright", name: "Frank Lloyd Wright (弗兰克·劳埃德·赖特)",
      contribution: {
    ...
    { id: "le_corbusier", name: "Le Corbusier (勒·柯布西耶)",
      contribution: {
    ...
    { id: "zaha_hadid", name: "Zaha Hadid (扎哈·哈迪德)",
      contribution: {
    ...
    { id: "martin_scorsese", name: "Martin Scorsese (马丁·斯科塞斯)",
      contribution: {
    ...
    { id: "christopher_nolan", name: "Christopher Nolan (克里斯托弗·诺兰)",
      contribution: {
    ...
    { id: "steven_spielberg", name: "Steven Spielberg (史蒂文·斯皮尔伯格)",
      contribution: {
    ...
    { id: "quentin_tarantino", name: "Quentin Tarantino (昆汀·塔伦蒂诺)",
      contribution: {
    ...
    { id: "denis_villeneuve", name: "Denis Villeneuve (丹尼斯·维伦纽瓦)",
      contribution: {
    ...
    { id: "john_williams", name: "John Williams (约翰·威廉姆斯)",
      contribution: {
    ...
    { id: "denzel_washington", name: "Denzel Washington (丹泽尔·华盛顿)",
      contribution: {
    ...
    { id: "leonardo_dicaprio", name: "Leonardo DiCaprio (莱昂纳多·迪卡普里奥)",
      contribution: {
    ...
    { id: "tom_hanks", name: "Tom Hanks (汤姆·汉克斯)",
      contribution: {
    ...
    { id: "robert_de_niro", name: "Robert De Niro (罗伯特·德尼罗)",
      contribution: {
    ...
    { id: "audrey_hepburn", name: "Audrey Hepburn (奥黛丽·赫本)",
      contribution: {
    ...
    { id: "al_pacino", name: "Al Pacino (阿尔·帕西诺)",
      contribution: {
    ...
    { id: "brad_pitt", name: "Brad Pitt (布拉德·皮特)",
      contribution: {
    ...
    { id: "joel_robuchon", name: "Joël Robuchon (乔埃尔·罗布雄)",
      contribution: {
    ...
    { id: "alain_ducasse", name: "Alain Ducasse (阿兰·杜卡斯)",
      contribution: {
    ...
    { id: "gordon_ramsay", name: "Gordon Ramsay (戈登·拉姆齐)",
      contribution: {
    ...
    { id: "shigeru_miyamoto", name: "Shigeru Miyamoto (宫本茂)",
      contribution: {
    ...
    { id: "hideo_kojima", name: "Hideo Kojima (小岛秀夫)",
      contribution: {
    ...
    { id: "sid_meier", name: "Sid Meier (席德·梅尔)",
      contribution: {
    ...
    { id: "john_carmack", name: "John Carmack (约翰·卡马克)",
      contribution: {
    ...
    { id: "hidetaka_miyazaki", name: "Hidetaka Miyazaki (宫崎英高)",
      contribution: {
    ...
    { id: "sissel_kyrkjebø", name: "Sissel Kyrkjebø (西塞尔·基尔克耶伯)",
      contribution: {
        "zh-CN": "挪威国宝级跨界女高音，为《泰坦尼克号》录制无词人声主题（电影中最具标志性的空灵女声），两次献唱奥运会开幕/闭幕式。",
        "en": "Norwegian crossover soprano, recorded the iconic wordless vocal theme for Titanic (the ethereal female voice in the film), performed at two Olympic ceremonies."
      },
      field: {
      ...
      remarks: {
        "zh-CN": "嗓音纯净空灵，被詹姆斯·霍纳称为“靠近天使的声音”，挪威史上最畅销女歌手。",
        "en": "Possesses an extraordinarily pure and ethereal voice, called 'the voice closest to an angel' by James Horner; Norway's best-selling female artist."
      }
    },
    { id: "maria_callas", name: "Maria Callas (玛利亚·卡拉斯)",
      contribution: {
    ...
    { id: "enrico_caruso", name: "Enrico Caruso (恩里科·卡鲁索)",
      contribution: {

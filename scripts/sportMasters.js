const sportMasters = [
    { id: "michael_phelps", name: "Michael Phelps (迈克尔·菲尔普斯)",
      contribution: {
    ...
    { id: "usain_bolt", name: "Usain Bolt (尤塞恩·博尔特)",
      contribution: {
    ...
    { id: "michael_jordan", name: "Michael Jordan (迈克尔·乔丹)",
      contribution: {
    ...
    { id: "muhammad_ali", name: "Muhammad Ali (穆罕默德·阿里)",
      contribution: {
    ...
    { id: "serena_williams", name: "Serena Williams (塞雷娜·威廉姆斯)",
      contribution: {
    ...
    { id: "lionel_messi", name: "Lionel Messi (利昂内尔·梅西)",
      contribution: {
    ...
    { id: "cristiano_ronaldo", name: "Cristiano Ronaldo (克里斯蒂亚诺·罗纳尔多)",
      contribution: {
    ...
    { id: "novak_djokovic", name: "Novak Djokovic (诺瓦克·德约科维奇)",
      contribution: {
    ...
    { id: "max_verstappen", name: "Max Verstappen (马克斯·维斯塔潘)",
      contribution: {
    ...
    { id: "tiger_woods", name: "Tiger Woods (老虎·伍兹)",
      contribution: {
    ...
    { id: "s1mple", name: "s1mple (亚历山大·科斯蒂列夫)",
      contribution: {

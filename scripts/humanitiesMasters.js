const humanitiesMasters = [
    ...
    {id: "jill_lepore",  name: "Jill Lepore (吉尔·莱波雷)",
      contribution: {
        "zh-CN": "撰写《美国历史》，以单卷本形式系统叙述美国从殖民地时期至当代的全史，强调事实、真相与民主理念的张力。",
        "en": "Authored These Truths: A History of the United States, a single-volume comprehensive history of the United States from colonial times to the present, emphasizing tensions between facts, truth, and democratic ideals."
      },
      field: {
        "zh-CN": "美国史、政治史、文化史。",
        "en": "American History, Political History, Cultural History."
      },
      remarks: {
        "zh-CN": "当代最具影响力的美国历史学家与公共知识分子之一，以清晰、优雅且面向广大读者的叙事风格著称。",
